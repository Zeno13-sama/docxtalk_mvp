...
const DemarquezVousDroite = () => {
  return (
    <div className="flex flex-col md:flex-row items-center justify-center mt-4 mx-auto p-6 rounded-lg shadow-lg md:space-x-6 w-11/12 md:w-3/4 lg:w-2/3">
      <div className="w-full md:w-1/2 p-4  rounded-lg  h-full flex flex-col justify-center">
        <h2 className="text-[3vw] md:text-[2vw] text-black font-bold mb-4 text-center md:text-left">
...
export default DemarquezVousDroite;
