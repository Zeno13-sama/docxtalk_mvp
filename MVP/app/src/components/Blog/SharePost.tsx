  ...
  return (
    <>
      <a
        ...
        className={`mb-3 inline-flex h-9 w-9 items-center justify-center rounded-sm  text-body-color duration-300 hover:bg-primary hover:text-white dark:bg-gray-dark dark:hover:bg-primary sm:ml-3 ${isDarkMode ? 'text-sky-700 ' : 'text-sky-700'}`}
      >
        <svg
          width="16"
          height="16"
      ...
      <a
        href="#0"
        aria-label="social-share"
        className={`mb-3 ml-3 inline-flex h-9 w-9 items-center justify-center rounded-sm bg-gray-light text-body-color duration-300 hover:bg-primary hover:text-white dark:bg-gray-dark dark:hover:bg-primary ${isDarkMode ? 'text-sky-500 ' : 'text-sky-500'}`}
      >
        <svg
          width="18"
          height="18"
