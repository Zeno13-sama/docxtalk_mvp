...
const NewsLatterBox = () => {
  ...
  return (
    <div className={`relative z-10 rounded-sm  p-8 shadow-three  sm:p-11 lg:p-8 xl:p-11 ${theme === 'dark' ? 'bg-gray-700' : ''}`}>
      <h3 className="mb-4 text-2xl font-bold leading-tight text-black dark:text-white">
        Subscribe to receive future updates
      </h3>
      <p className="mb-11 border-b border-body-color border-opacity-25 pb-11 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
      Subscribe to our newsletter to receive exclusive updates, helpful tips, and special offers straight to your inbox. Stay informed and get content that matters to you.
      </p>
      <div>
        <input
          type="text"
        ...
        type="submit"
        value="Subscribe"
        className="mb-5 flex w-full cursor-pointer items-center justify-center rounded-sm bg-sky-400  px-9 py-4  font-medium text-white shadow-submit duration-300 hover:bg-sky-500 dark:shadow-submit-dark dark:bg-sky-700"
        />
