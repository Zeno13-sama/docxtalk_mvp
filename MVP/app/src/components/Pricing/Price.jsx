...
const Pricing = () => {
  ...
  return (
    <>
        <Helmet>
          <title>Pricing - Find the right plan for your needs | DocxTalk</title>
          <meta
            name="description"
            content="Discover our flexible pricing plans and choose the one that suits your needs for simplified management of your documents."
          />
        </Helmet>
        <section
        id="pricing"
